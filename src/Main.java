public class Main {
	...
	public static void main(String[] args) {
		...
		AAA aaa = new AAA();		//부모 클래스에서 상속을 받은 자식 클래스에서 출력한 결과 값을 가져온다.
		aaa.printName();			
		// <결과>
		// 김길동
		...
		BB bb = new BBB(); //부모 클래스에서 상속을 받은 자식 클래스에서 출력한 결과 값을 부모 클래스에서 받은 다음 가져온다.
		bb.printName();		
		// <결과>
		// 김길동
		...
		CC cc = new CCC(); //부모 클래스에서 상속을 받은 자식 클래스에서 출력한 결과 값을 부모 클래스에서 받은 다음 가져온다.
		cc.printName();		
		// <결과>
		// 김길동
